...
/*
 * Setup for a Generic HT32F1655/6 board.
 */

/*
 * Board identifier.
 */
#define BOARD_HT32_F1655_6
#define BOARD_NAME              "Generic HT32F1655/6 Board"
...
#define VAL_GPIOB_INER          (PIN_INPUT_ENABLE(GPIOB_PIN0) | \
                                 ...
                                 PIN_INPUT_DISABLE(GPIOB_PIN12) | \
                                 PIN_INPUT_DISABLE(GPIOB_PIN13) | \
                                 PIN_INPUT_DISABLE(GPIOB_PIN14) | \
                                 PIN_INPUT_DISABLE(GPIOB_PIN15))
#define VAL_GPIOB_PUR           (PIN_PULLUP_ENABLE(GPIOB_PIN0) | \
                                 ...
                                 PIN_PULLUP_DISABLE(GPIOB_PIN12) | \
                                 PIN_PULLUP_DISABLE(GPIOB_PIN13) | \
                                 PIN_PULLUP_DISABLE(GPIOB_PIN14) | \
                                 PIN_PULLUP_DISABLE(GPIOB_PIN15))
...
#define VAL_GPIOB_AFCFGR1       (PIN_AFIO_AF(GPIOB_PIN0, AFIO_GPIO) | \
                                 ...
                                 PIN_AFIO_AF(GPIOB_PIN12, AFIO_DEFAULT) | \
                                 PIN_AFIO_AF(GPIOB_PIN13, AFIO_DEFAULT) | \
                                 PIN_AFIO_AF(GPIOB_PIN14, AFIO_DEFAULT) | \
                                 PIN_AFIO_AF(GPIOB_PIN15, AFIO_DEFAULT))
...
#define VAL_GPIOC_INER          (PIN_INPUT_ENABLE(GPIOC_PIN0) | \
                                 ...
                                 PIN_INPUT_ENABLE(GPIOC_PIN6) | \
                                 PIN_INPUT_ENABLE(GPIOC_PIN7) | \
...
#define VAL_GPIOC_PUR           (PIN_PULLUP_ENABLE(GPIOC_PIN0) | \
                                 ...
                                 PIN_PULLUP_ENABLE(GPIOC_PIN6) | \
                                 PIN_PULLUP_ENABLE(GPIOC_PIN7) | \
...
#define VAL_GPIOC_AFCFGR0       (PIN_AFIO_AF(GPIOC_PIN0, AFIO_GPIO) | \
                                 ...
                                 PIN_AFIO_AF(GPIOC_PIN6, AFIO_GPIO) | \
                                 PIN_AFIO_AF(GPIOC_PIN7, AFIO_GPIO))
 ...
 * Everything GPIO input with pull-up
 */
#define VAL_GPIOE_DIRCR         (PIN_MODE_INPUT(GPIOE_PIN0) | \
...
#define VAL_GPIOE_INER          (PIN_INPUT_ENABLE(GPIOE_PIN0) | \
                                 PIN_INPUT_ENABLE(GPIOE_PIN1) | \
                                 PIN_INPUT_ENABLE(GPIOE_PIN2) | \
                                 PIN_INPUT_ENABLE(GPIOE_PIN3) | \
                                 PIN_INPUT_ENABLE(GPIOE_PIN4) | \
                                 PIN_INPUT_ENABLE(GPIOE_PIN5) | \
                                 PIN_INPUT_ENABLE(GPIOE_PIN6) | \
                                 PIN_INPUT_ENABLE(GPIOE_PIN7) | \
                                 PIN_INPUT_ENABLE(GPIOE_PIN8) | \
                                 PIN_INPUT_ENABLE(GPIOE_PIN9) | \
                                 PIN_INPUT_ENABLE(GPIOE_PIN10) | \
                                 PIN_INPUT_ENABLE(GPIOE_PIN11) | \
                                 PIN_INPUT_ENABLE(GPIOE_PIN12) | \
                                 PIN_INPUT_ENABLE(GPIOE_PIN13) | \
                                 PIN_INPUT_ENABLE(GPIOE_PIN14) | \
                                 PIN_INPUT_ENABLE(GPIOE_PIN15))
#define VAL_GPIOE_PUR           (PIN_PULLUP_ENABLE(GPIOE_PIN0) | \
                                 PIN_PULLUP_ENABLE(GPIOE_PIN1) | \
                                 PIN_PULLUP_ENABLE(GPIOE_PIN2) | \
                                 PIN_PULLUP_ENABLE(GPIOE_PIN3) | \
                                 PIN_PULLUP_ENABLE(GPIOE_PIN4) | \
                                 PIN_PULLUP_ENABLE(GPIOE_PIN5) | \
                                 PIN_PULLUP_ENABLE(GPIOE_PIN6) | \
                                 PIN_PULLUP_ENABLE(GPIOE_PIN7) | \
                                 PIN_PULLUP_ENABLE(GPIOE_PIN8) | \
                                 PIN_PULLUP_ENABLE(GPIOE_PIN9) | \
                                 PIN_PULLUP_ENABLE(GPIOE_PIN10) | \
                                 PIN_PULLUP_ENABLE(GPIOE_PIN11) | \
                                 PIN_PULLUP_ENABLE(GPIOE_PIN12) | \
                                 PIN_PULLUP_ENABLE(GPIOE_PIN13) | \
                                 PIN_PULLUP_ENABLE(GPIOE_PIN14) | \
                                 PIN_PULLUP_ENABLE(GPIOE_PIN15))
#define VAL_GPIOE_PDR           (PIN_PULLDOWN_DISABLE(GPIOE_PIN0) | \
                                 PIN_PULLDOWN_DISABLE(GPIOE_PIN1) | \
                                 PIN_PULLDOWN_DISABLE(GPIOE_PIN2) | \
                                 PIN_PULLDOWN_DISABLE(GPIOE_PIN3) | \
                                 PIN_PULLDOWN_DISABLE(GPIOE_PIN4) | \
                                 PIN_PULLDOWN_DISABLE(GPIOE_PIN5) | \
                                 PIN_PULLDOWN_DISABLE(GPIOE_PIN6) | \
                                 PIN_PULLDOWN_DISABLE(GPIOE_PIN7) | \
                                 PIN_PULLDOWN_DISABLE(GPIOE_PIN8) | \
                                 PIN_PULLDOWN_DISABLE(GPIOE_PIN9) | \
                                 PIN_PULLDOWN_DISABLE(GPIOE_PIN10) | \
                                 PIN_PULLDOWN_DISABLE(GPIOE_PIN11) | \
                                 PIN_PULLDOWN_DISABLE(GPIOE_PIN12) | \
                                 PIN_PULLDOWN_DISABLE(GPIOE_PIN13) | \
                                 PIN_PULLDOWN_DISABLE(GPIOE_PIN14) | \
                                 PIN_PULLDOWN_DISABLE(GPIOE_PIN15))
#define VAL_GPIOE_ODR           (PIN_ODR_PUSHPULL(GPIOE_PIN0) | \
                                 PIN_ODR_PUSHPULL(GPIOE_PIN1) | \
                                 PIN_ODR_PUSHPULL(GPIOE_PIN2) | \
                                 PIN_ODR_PUSHPULL(GPIOE_PIN3) | \
                                 PIN_ODR_PUSHPULL(GPIOE_PIN4) | \
                                 PIN_ODR_PUSHPULL(GPIOE_PIN5) | \
                                 PIN_ODR_PUSHPULL(GPIOE_PIN6) | \
                                 PIN_ODR_PUSHPULL(GPIOE_PIN7) | \
                                 PIN_ODR_PUSHPULL(GPIOE_PIN8) | \
                                 PIN_ODR_PUSHPULL(GPIOE_PIN9) | \
                                 PIN_ODR_PUSHPULL(GPIOE_PIN10) | \
                                 PIN_ODR_PUSHPULL(GPIOE_PIN11) | \
                                 PIN_ODR_PUSHPULL(GPIOE_PIN12) | \
                                 PIN_ODR_PUSHPULL(GPIOE_PIN13) | \
                                 PIN_ODR_PUSHPULL(GPIOE_PIN14) | \
                                 PIN_ODR_PUSHPULL(GPIOE_PIN15))
#define VAL_GPIOE_DRVR          (PIN_DRVR_4MA(GPIOE_PIN0) | \
                                 PIN_DRVR_4MA(GPIOE_PIN1) | \
                                 PIN_DRVR_4MA(GPIOE_PIN2) | \
                                 PIN_DRVR_4MA(GPIOE_PIN3) | \
                                 PIN_DRVR_4MA(GPIOE_PIN4) | \
                                 PIN_DRVR_4MA(GPIOE_PIN5) | \
                                 PIN_DRVR_4MA(GPIOE_PIN6) | \
                                 PIN_DRVR_4MA(GPIOE_PIN7) | \
                                 PIN_DRVR_4MA(GPIOE_PIN8) | \
                                 PIN_DRVR_4MA(GPIOE_PIN9) | \
                                 PIN_DRVR_4MA(GPIOE_PIN10) | \
                                 PIN_DRVR_4MA(GPIOE_PIN11) | \
                                 PIN_DRVR_4MA(GPIOE_PIN12) | \
                                 PIN_DRVR_4MA(GPIOE_PIN13) | \
                                 PIN_DRVR_4MA(GPIOE_PIN14) | \
                                 PIN_DRVR_4MA(GPIOE_PIN15))
#define VAL_GPIOE_AFCFGR0       (PIN_AFIO_AF(GPIOE_PIN0, AFIO_GPIO) | \
                                 PIN_AFIO_AF(GPIOE_PIN1, AFIO_GPIO) | \
                                 PIN_AFIO_AF(GPIOE_PIN2, AFIO_GPIO) | \
                                 PIN_AFIO_AF(GPIOE_PIN3, AFIO_GPIO) | \
                                 PIN_AFIO_AF(GPIOE_PIN4, AFIO_GPIO) | \
                                 PIN_AFIO_AF(GPIOE_PIN5, AFIO_GPIO) | \
                                 PIN_AFIO_AF(GPIOE_PIN6, AFIO_GPIO) | \
                                 PIN_AFIO_AF(GPIOE_PIN7, AFIO_GPIO))
#define VAL_GPIOE_AFCFGR1       (PIN_AFIO_AF(GPIOE_PIN0, AFIO_GPIO) | \
                                 PIN_AFIO_AF(GPIOE_PIN8, AFIO_GPIO) | \
                                 PIN_AFIO_AF(GPIOE_PIN9, AFIO_GPIO) | \
                                 PIN_AFIO_AF(GPIOE_PIN10, AFIO_GPIO) | \
                                 PIN_AFIO_AF(GPIOE_PIN11, AFIO_GPIO) | \
                                 PIN_AFIO_AF(GPIOE_PIN12, AFIO_GPIO) | \
                                 PIN_AFIO_AF(GPIOE_PIN13, AFIO_GPIO) | \
                                 PIN_AFIO_AF(GPIOE_PIN14, AFIO_GPIO) | \
                                 PIN_AFIO_AF(GPIOE_PIN15, AFIO_GPIO))
